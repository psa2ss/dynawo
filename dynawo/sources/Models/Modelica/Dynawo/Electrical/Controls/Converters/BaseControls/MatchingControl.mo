...
model MatchingControl "Matching Control"
  ...
  Modelica.Blocks.Interfaces.RealInput UdcRefPu(start = Udc0Pu) "reference voltage on the dc side in pu (base UNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput UdcPu(start = Udc0Pu) "voltage on the dc side in pu (base UNom)" annotation(
