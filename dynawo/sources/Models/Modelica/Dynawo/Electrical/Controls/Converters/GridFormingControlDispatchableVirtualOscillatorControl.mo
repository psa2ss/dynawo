...
model GridFormingControlDispatchableVirtualOscillatorControl "Grid Forming Control with Dispatchable Virtual Oscillator Control"
  ...
  Modelica.Blocks.Interfaces.RealInput UdcRefPu (start = Udc0Pu) "reference DC voltage on the DC side in pu (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput UdcPu (start = Udc0Pu) "DC voltage on the DC side in pu (base UNom, SNom)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput UdcRefOutPu (start = Udc0Pu) "reference DC voltage on the DC side in pu (base UNom, SNom)" annotation(
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.DCVoltageControl dCVoltageControl(Kpdc = Kpdc, IdcSource0Pu = IdcSource0Pu, IdcSourceRef0Pu = IdcSourceRef0Pu, Udc0Pu = Udc0Pu)  annotation(
...
equation
  ...
  connect(UdcRefPu, UdcRefOutPu) annotation(
