...
model GridFormingControlMatchingControl "Grid Forming Control with Matching Control"
  ...
  Dynawo.Electrical.Controls.Converters.BaseControls.MatchingControl matchingControl(KMatching = KMatching, Theta0 = Theta0, Udc0Pu = Udc0Pu, UdFilter0Pu = UdFilter0Pu)  annotation(
    Placement(visible = true, transformation(origin = {-15, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(UdcRefPu, matchingControl.UdcRefPu) annotation(
  ...
  connect(UdcPu, matchingControl.UdcPu) annotation(
