...
model GfolConverterDroop "Grid Following Converter: assembling a VCS converter model with grid following and DC side control"
...
//Operational values
  ...
  Dynawo.Electrical.Controls.Converters.GridFormingControlDroopControl Droop(Cfilter = Cfilter, Kff = Kff, Kic = Kic, Kiv = Kiv, KpVI = KpVI, Kpc = Kpc, Kpdc = Kpdc, Kpv = Kpv, Lfilter = Lfilter, Mp = Mp, Mq = Mq, Rfilter = Rfilter, Wf = Wf, Wff = Wff, XRratio = XRratio) "Droop controlled grid-forming converter" annotation(
    Placement(visible = true, transformation(origin = {30, 2.44249e-15}, extent = {{24, 24}, {-24, -24}}, rotation = 0)));
  ...
  Dynawo.Connectors.ACPower aCPower annotation(
    Placement(visible = true, transformation(origin = {-89.5, 0.5}, extent = {{-9.5, -9.5}, {9.5, 9.5}}, rotation = 0), iconTransformation(origin = {-110, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(Droop.omegaPu, vSCIdcSource.omegaPu) annotation(
    Line);
  connect(Droop.uqConvRefPu, vSCIdcSource.uqConvPu) annotation(
    Line);
  connect(Droop.udConvRefPu, vSCIdcSource.udConvPu) annotation(
    Line);
  connect(Droop.theta, vSCIdcSource.theta) annotation(
    Line);
  connect(Droop.IdcSourcePu, vSCIdcSource.IdcSourcePu) annotation(
    Line);
  connect(IdcSourceRefPu.y, Droop.IdcSourceRefPu) annotation(
    Line(points = {{78, 22}, {70, 22}, {70, 14}, {55, 14}}, color = {0, 0, 127}));
  connect(UFilterRefPu.y, Droop.UFilterRefPu) annotation(
    Line(points = {{78, -20}, {76, -20}, {76, 0}, {55, 0}}, color = {0, 0, 127}));
  connect(QRefPu.y, Droop.QRefPu) annotation(
    Line(points = {{78, -56}, {70, -56}, {70, -14}, {55, -14}}, color = {0, 0, 127}));
  connect(PrefPu.y, Droop.PRefPu) annotation(
    Line(points = {{78, -88}, {60, -88}, {60, -24}, {55, -24}}, color = {0, 0, 127}));
  connect(vSCIdcSource.terminal, aCPower) annotation(
    Line(points = {{-63.5, 0}, {-89.5, 0}}, color = {0, 0, 255}));
  connect(vSCIdcSource.iqConvPu, Droop.iqConvPu) annotation(
    Line(points = {{-14, -27}, {-14, -34}, {38, -34}, {38, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.idConvPu, Droop.idConvPu) annotation(
    Line(points = {{-19, -27}, {-19, -40}, {23, -40}, {23, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.uqFilterPu, Droop.uqFilterPu) annotation(
    Line(points = {{-25, -27}, {-25, -50}, {52, -50}, {52, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.UdcPu, Droop.UdcPu) annotation(
    Line(points = {{-36, -27}, {-36, -70}, {30, -70}, {30, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.idPccPu, Droop.idPccPu) annotation(
    Line(points = {{-63, -20}, {-64, -20}, {-64, -80}, {16, -80}, {16, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.iqPccPu, Droop.iqPccPu) annotation(
    Line(points = {{-63, -13}, {-74, -13}, {-74, -90}, {44, -90}, {44, -25}}, color = {0, 0, 127}));
  connect(vSCIdcSource.udFilterPu, Droop.udFilterPu) annotation(
    Line(points = {{-30, -27}, {-30, -60}, {10, -60}, {10, -26}}, color = {0, 0, 127}));
  connect(omegaRefPu.y, Droop.omegaRefPu) annotation(
    Line(points = {{78, 90}, {8, 90}, {8, 26}, {8, 26}}, color = {0, 0, 127}));
  connect(UdcRefPu.y, Droop.UdcRefPu) annotation(
    Line(points = {{78, 58}, {60, 58}, {60, 24}, {56, 24}, {56, 24}}, color = {0, 0, 127}));

annotation(
    Icon(coordinateSystem(initialScale = 0.1, grid = {1, 1}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}})}));
end GfolConverterDroop;
